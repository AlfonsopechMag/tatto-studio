...
export default function Piercing() {
  return (
    <div className="piercing" id='Piercing'>
      <div className="container text-light">
        <div className="row d-flex flex-column justify-content-center align-items-center">                
            <h1 className='col text-center titulo fw-bold py-4 '>PIERCING</h1>
            <div className="col-12 d-flex  justify-content-center pt-1">
              <img src="https://i.ibb.co/NV1sYJk/17.png" alt="17" border="0"></img>
            </div>                                          
            ...
            <div className="col-12 d-flex  justify-content-center pt-1">
              <img src="https://i.ibb.co/GvH96yS/18.png" alt="17" border="0"></img>             
            </div>
        </div>
      </div>
    </div>
